...
class SearchAndContents(BaseTool):
    ...
    description: str = (
        "Searches the web based on a search query for the latest results. Results are only from the last 7 days. Uses the Exa API. This also returns the contents of the search results."
    )
